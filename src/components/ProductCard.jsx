    ...
    <>
      ...
      <div className="flex flex-col group bg-white dark:bg-gray-900 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800">
        <div className="relative aspect-[4/5] overflow-hidden bg-gray-100">
          <div className="absolute top-3 left-3 bg-primary text-white text-xs font-bold px-2 py-1 rounded-md z-10">New</div>
        ...
        <div className="p-4 flex flex-col gap-2">
          <h3 className="text-base font-semibold text-[#181113] dark:text-white line-clamp-1">X-pression Ultra Braid 82"</h3>
          <div className="flex items-center gap-1 text-yellow-400 text-sm">
            <span className="material-symbols-outlined" style={{ fontSize: "16px", fontVariationSettings: "'FILL' 1" }}>star</span>
            <span className="text-gray-500 dark:text-gray-400 text-xs">(4.8)</span>
          </div>
          <div className="flex items-center justify-between mt-1">
            <span className="text-lg font-bold text-[#181113] dark:text-white">$5.99</span>
      ...
      <div className="flex flex-col group bg-white dark:bg-gray-900 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800">
        <div className="relative aspect-[4/5] overflow-hidden bg-gray-100">
          <div className="absolute top-3 left-3 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-md z-10">Best Seller</div>
          <button className="absolute top-3 right-3 bg-white/80 dark:bg-black/50 p-1.5 rounded-full text-gray-600 dark:text-gray-300 hover:text-primary hover:bg-white transition-all z-10">
            <span className="material-symbols-outlined" style={{ fontSize: "20px" }}>favorite</span>
          </button>
          <div 
        ...
        <div className="p-4 flex flex-col gap-2">
          <h3 className="text-base font-semibold text-[#181113] dark:text-white line-clamp-1">Bohemian Curl Crochet 14"</h3>
          <div className="flex items-center gap-1 text-yellow-400 text-sm">
            <span className="material-symbols-outlined" style={{ fontSize: "16px", fontVariationSettings: "'FILL' 1" }}>star</span>
            <span className="text-gray-500 dark:text-gray-400 text-xs">(4.9)</span>
          </div>
          <div className="flex items-center justify-between mt-1">
            <span className="text-lg font-bold text-[#181113] dark:text-white">$12.50</span>
            <div className="flex gap-1">
      ...
      <div className="flex flex-col group bg-white dark:bg-gray-900 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800">
        ...
        <div className="p-4 flex flex-col gap-2">
          <h3 className="text-base font-semibold text-[#181113] dark:text-white line-clamp-1">Ombre 613 Blonde Braid</h3>
          <div className="flex items-center gap-1 text-yellow-400 text-sm">
            <span className="material-symbols-outlined" style={{ fontSize: "16px", fontVariationSettings: "'FILL' 1" }}>star</span>
            <span className="text-gray-500 dark:text-gray-400 text-xs">(4.5)</span>
          </div>
          <div className="flex items-center justify-between mt-1">
            <span className="text-lg font-bold text-[#181113] dark:text-white">$8.00</span>
            <div className="flex gap-1">
      ...
      <div className="flex flex-col group bg-white dark:bg-gray-900 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800">
        ...
        <div className="p-4 flex flex-col gap-2">
          <h3 className="text-base font-semibold text-[#181113] dark:text-white line-clamp-1">Royal Gold Cuffs Set</h3>
          <div className="flex items-center gap-1 text-yellow-400 text-sm">
            <span className="material-symbols-outlined" style={{ fontSize: "16px", fontVariationSettings: "'FILL' 1" }}>star</span>
            <span className="text-gray-500 dark:text-gray-400 text-xs">(5.0)</span>
          </div>
          <div className="flex items-center justify-between mt-1">
            <span className="text-lg font-bold text-[#181113] dark:text-white">$4.50</span>
            <div className="flex gap-1">
